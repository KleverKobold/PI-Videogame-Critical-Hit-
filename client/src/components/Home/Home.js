    ...
    return (
      <div className="loading">
        ...
        <p className="loadingTxt">
          We are looking for your Games in our Dungeon...
        </p>
      </div>
    );
  }
    ...
    <div className="homeScreen">
      <div className="navbar">
        ...
        <div>
          ...
          <Link to="/game" className="linkToCreate">
            Add your favorite Videogame
          </Link>
        </div>
      </div>
